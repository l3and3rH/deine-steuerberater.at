      ...
      <div className="flex gap-4 px-4 py-4 pl-6 sm:gap-5 sm:px-6 sm:py-5 sm:pl-7">
        ...
        <div className="flex-shrink-0 flex flex-col items-center gap-2 pt-0.5">
          {logo ? (
            ...
            >
              <span className="font-display text-xl sm:text-2xl font-semibold text-white/90 select-none">
                {name.charAt(0)}
              </span>
            </div>
          )}
          ...
          <div className="mt-3 pt-3 border-t border-forest-50">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {telefon && (
                <a
                  href={`tel:${telefon}`}
                  className="inline-flex items-center gap-1.5 bg-forest-900 text-cream-100 hover:bg-forest-700 px-4 py-2 rounded-lg font-semibold text-xs transition-colors flex-1 sm:flex-none justify-center sm:justify-start"
                >
              ...
              {email && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 border border-forest-200 text-forest-700 hover:bg-forest-50 px-4 py-2 rounded-lg font-semibold text-xs transition-colors flex-1 sm:flex-none justify-center sm:justify-start"
                >
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
